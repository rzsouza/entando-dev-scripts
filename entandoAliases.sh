...
alias a_m='e && mvn archetype:generate -DarchetypeGroupId=org.entando.entando -DarchetypeArtifactId=entando-archetype-webapp-generic -DarchetypeCatalog=local -B -DgroupId=myapp -DartifactId=myapp -o && cd myapp'
